...
Class Barang extends Ci_Controller {
    ...
    function edit() {
        if (isset($_POST['submit'])) {
            ...
            $data['barang']     = $this->db->get_where('barang', array('id_barang' => $id))->row_Array();
            $datas['gallery']     = $this->db->get_where('gallery', array('id_galeri' => $id))->row_Array();
            $this->template->load('templateadmin', 'barang/edit', $data,$datas);
        }
    }

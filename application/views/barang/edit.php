                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" value="<?php echo $barang['harga_sewa'] ?>" name="harga_sewa" class="form-control" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <?php echo cmb_dinamis('kategori', 'kategori', 'nama_kategori', 'id_kategori',$barang['id_kategori']) ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <div>
                                    <label>
                                        <input type="number" name="stock" value="<?php echo $barang['stock'] ?>" class="form-control">
                                    </label>
                                </div>
                            </div>
                        </div>
